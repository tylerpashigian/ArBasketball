  ...
  _getPhysicsGroup(){
    ...
    return (
      ...
      <ViroNode position={this.state.planePosition}>
        ...
        <ViroBox
          position={[0.875/3,1.75,-.875/3]}
          scale={[.33,.33,.33]}
          rotation={[0, 90, 0]}
          materials={'white'}
          physicsBody={{ type:'Static', restitution:0.25 }}
          height={2} width={.25} length={4}
          />
        ...
        <ViroQuad position={[1,0,0]} scale={[6.0, 8.0, 1.0]} rotation={[-90, 0, 0]} physicsBody={{ type:'Static', restitution:0.75 }}
...
ViroMaterials.createMaterials({
  ...
  basketball_hoop: {
    shininess: 2.0,
    diffuseTexture: require('./res/physics/basketball_hoop_diffuse_noAO.jpg'),
  },
 });
